...
import { userTransfersTableFilterContentContext } from "./hooks";
import { TransferTableFilterContentProps } from "./types";

export const TransfersTableFilterContent = (
  props: TransferTableFilterContentProps
) => {
  const { getCustomChangeHandler, handleChange, handleSubmit, reset, values } =
    props.formContext;
  const { statusItems, transformDateValue } =
    userTransfersTableFilterContentContext(values);
